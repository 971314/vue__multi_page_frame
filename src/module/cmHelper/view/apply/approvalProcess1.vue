      ...
      <div class="process_bottom">
        <div>
          <div class="process_cell" v-for=" (datas,i) in processData">
            <div>
              <span>{{i == 0 ? '当前' : datas.operateTime?$$dateInterception(datas.operateTime, 5, 16):$$dateInterception(datas.arriveTime, 5, 16)}}</span>
              <i
                v-if="i == 0 && datas.operateTypeId == '0' || i == 0 && datas.operateTypeId == '1' || i == 0 && datas.operateTypeId == '5' "
                class="by1"></i>
            ...
            <div v-if="i == 0">
              <div class="paddingDiv"
                :class="{'c1':i == 0 && datas.operateTypeId == '1' || i == 0 && datas.operateTypeId == '5','c2':i == 0 && datas.operateTypeId == '2','c3':i == 0 && datas.operateTypeId == '3'}">
                {{datas.operateType}}
              </div>
              <div>{{datas.operatorName}} {{datas.departName}}</div>
            </div>
            <div v-else>
              <div>{{datas.operatorName}} {{datas.departName}}</div>
              <div>{{datas.operatorName}} {{datas.departName}}</div>

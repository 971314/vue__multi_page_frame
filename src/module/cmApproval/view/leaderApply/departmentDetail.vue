      ...
      <div class="customer-info-grid">
        <div class="customer-info-group">
          <div class="info-group-first">
            <span class="group-first-text" v-text="$$comma((departInfo.EQUITY / 10000).toFixed(2))"></span>
          ...
          <div class="info-group-second">
            <div class="group-second-item">
              ...
              <span class="second-item-text" v-text="departInfo.CUST_NUM"></span>
            </div>
            <div class="group-second-item">
              <span class="second-item-title">
                本月开户
              </span>
              <span class="second-item-text" v-text="departInfo.CUST_ADD_M"></span>
            </div>
            <div class="group-second-item">
              <span class="second-item-title">
                活跃客户
              </span>
              <span class="second-item-text" v-text="departInfo.ACTIVE_CUST"></span>
            </div>
          </div>
        </div>
      </div>

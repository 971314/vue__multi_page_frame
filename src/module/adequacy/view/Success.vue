<template>
  <div class="success">
    ...
    <div class="text-center icon-success-warp">
      <img class="icon-success" src="../images/icon-success.png"/>
    </div>
    <div class="content text-center">
      <div v-for="(item, index) in cfAdequacyJson.view.success.text" :key="index" v-text="item"></div>
    </div>

    <div class="relative infoS">
      <div class="btn-group">
        <button class="btn next" @click="close">退出</button>
        <!--<button class="btn next" @click="goNewAccount">继续开户</button>-->
      </div>
    </div>
  </div>
</template>

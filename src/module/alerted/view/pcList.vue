    ...
    <div id="TableList">
      ...
      <div class="TbodyWrap" id="alertList">
        <div class="TbodyInner">
          <table class="brief static">
            <tbody>
            <tr class="clickBack1" v-for="(myVal,i) in myAlerted" v-tap="[deleteListShow,myVal.conditionID,i]" :key="i">
          ...
          <div class="detailOuter">
            <table class="detail staticBody">
              <tbody>
              <tr class="clickBack" v-for="(myVal,i) in myAlerted" v-tap="[deleteListShow,myVal.conditionID,i]"
                  :key="i">
                <state-change :flag1="myVal.flag1" :flag3="myVal.flag3"></state-change>
                <!--<td :class="{none : myVal.flag3 == 25 || myVal.flag3 == 29 || myVal.flag3 == 24}">{{myVal.newPrice}}</td>-->
...
//          pbPage.addModuleCallback(90000, this.marketCallback);
          ...
          pbPage.addReloadFunByKey('alertedP', this.pageReload);
        } else {
          pbPage.initPage({
            callbacks: [
...
//              }
      ...
      pageReload() {
        console.log('pageReload alertedp');
